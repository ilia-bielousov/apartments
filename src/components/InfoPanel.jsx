    ...
    <div className="flex flex-col h-full p-4 bg-white rounded-lg shadow-sm">
      <div className="flex justify-between items-center pb-2 border-b-2 border-blue-600 mb-4">
        ...
        <button
          ...
          className="text-gray-500 hover:text-red-600 text-lg transition-colors cursor-pointer"
        >
          Закрыть
        </button>
      </div>
      ...
      <button className="block w-full py-2 rounded-md text-blue-600 border border-blue-600 bg-white hover:bg-blue-50 font-semibold mt-3 transition-colors cursor-pointer">
        Зарезирвировать
      </button>
    </div>
  );
